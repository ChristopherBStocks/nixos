...
# nix run github:nix-community/nixos-anywhere -- --flake .#<host> -i ~/.ssh/deploy  root@<ip>
{
  ...
  in
  {
    nixosConfigurations = {
       ...
       hgnixprod02 = nixpkgs.lib.nixosSystem {
         system = "x86_64-linux";
         modules = [
           disko.nixosModules.disko
           ./hosts/hgnixprod02/configuration.nix
         ];
       };
    };
    colmena = {
